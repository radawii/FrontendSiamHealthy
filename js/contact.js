        ...
        <div class="footer-container">
          <div class="footer-grid">
            ...
            <div class="footer-col">
              ...
              <!-- Customer Support Box (เบอร์โทร) -->
              <div class="cs-box">
                <div class="cs-icon-circle">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
                </div>
                <div class="cs-details">
                  <span class="cs-label">Customer Support</span>
                  <a href="tel:0955303986" class="cs-number">095-5303986</a>
                  <span class="cs-time">จ-ศ 09:00 - 18:00 น.</span>
                </div>
              </div>

              <!-- Social Media Icons -->
              <div class="social-wrapper">
                <span class="social-heading">ติดตามเราผ่านช่องทางออนไลน์</span>
                <div class="social-icons-grid">
                  
                  <!-- LINE -->
                  <a href="https://lin.ee/i0aQZCJ" target="_blank" class="social-badge badge-line" title="LINE Official">
                  ...
                  <!-- Facebook -->
                  <a href="https://www.facebook.com/AscenderThailand/" target="_blank" class="social-badge badge-fb" title="Facebook Page">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                  </a>

                  <!-- TikTok -->
                  <a href="https://www.tiktok.com/@siam_healthy?is_from_webapp=1&sender_device=pc" target="_blank" class="social-badge badge-tk" title="TikTok">
                  ...
                  <!-- Shopee -->
                  <a href="https://s.shopee.co.th/80BTRyG09q" target="_blank" class="social-badge badge-sp" title="Shopee Store">
